...
{
    /// <summary>
    /// Class chứa danh sách các nguyên liệu cần kiểm kho
    /// </summary>
    public class cartTruocKiemKho
    {
        ...
        public void addCart(ctTonKho x)
        {
            ...
            {
                xulyFile.ghiLoi("Class: cartTruocKiemKho - Function: addCart", ex.Message);
            }
        }
        /// <summary>
        ...
        public void removeItem(int maNguyenLieu)
        {
            ...
            {
                xulyFile.ghiLoi("Class: cartTruocKiemKho - Function: removeItem", ex.Message);
            }
        }
        /// <summary>
