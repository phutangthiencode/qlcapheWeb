...
{
    public class xulyMaHoa
    {
        /// <summary>
        /// Hàm thực hiện mã hóa chuỗi theo kiểu SHA 256
        /// Key là 02111996
        /// </summary>
        ...
        {
            string encData = null;
            byte[][] keys = GetHashKeys("02111996");
        ...
        /// <summary>
        /// Hàm thực hiện giải mã chuỗi SHA 256 
        /// Key là: 02111996
        /// </summary>
        ...
        /// <summary>
        /// Hàm giải mã chuỗi với khóa
        /// </summary>
        /// <param name="data"></param>
        /// <param name="key"></param>
        /// <returns>Chuỗi đã giải mã</returns>
        public static string DecryptWithKey(string data, string key)
        {
            string decData = null;
            byte[][] keys = GetHashKeys(key);
