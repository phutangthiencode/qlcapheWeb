...
function ajaxThemChiTiet() {
    $('#btnThemHangVaoPhieu').click(function () {
        ...
        var ts = $('#maNguyenLieuDaChon').val() + '|' + $('#cbbNhaCungCap').val() + '|' + $('#txtSoLuongNhap').val() + '|' + $('#txtDonGiaNhap').val() + '|' + $('#txtGhiChuCt').val();
        $.ajax({
            url: getDuongDan() + 'NhapKho/AjaxThemChiTietVaTraVeBang?duLieu=' + ts,
            type: 'GET',
            context: this,
            dataType: 'html',
            beforeSend: function () {
...
function ajaxXoaTatCaChiTiet() {
    $('#btnXoaTatCa').click(function () {
        $.ajax({
            url: getDuongDan() + 'NhapKho/AjaxXoaTatCaChiTiet',
            type: 'GET',
            context: this,
            dataType: 'html',
            beforeSend: function () {
...
function ajaxXoaMotChiTiet() {
    $("#vungDsChiTiet").on("click", ".xoaChiTiet", function (event) {
        ...
        $.ajax({
            url: getDuongDan() + 'NhapKho/AjaxXoaMotChitiet?maCt=' + maBuoc,
            type: 'GET',
            context: this,
            dataType: 'html',
            beforeSend: function () {
